...
using SysBot.Pokemon.ConsoleApp.API.Hubs;
using SysBot.Pokemon.ConsoleApp.WebApi;
using PKHeX.Core;
using PKHeX.Core.AutoMod;

namespace SysBot.Pokemon.ConsoleApp.API.Services;
...
public class TradeHubService
{
    ...
    // Static host reference - set via Initialize()
    ...
    /// <summary>
    /// Initializes the service with an IBotHost instance.
    /// Must be called before the ASP.NET Core host is started.
    /// </summary>
    ...
    {
        var botRunner = _host?.GetBotRunner();
        if (botRunner == null)
        {
